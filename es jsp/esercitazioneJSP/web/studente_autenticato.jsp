<%-- 
    Document   : studente_autenticato
    Created on : 15-apr-2016, 12.12.35
    Author     : studente
--%>
        ...
        <div id="page">
            ...
            <div id="content">
                <div class="input-form">
                    <h3>Bentornato ${studente.nome} ${studnte.cognome}</h3>
                    ...
                    <div>
                        ...
                        <ul>
                            <c:forEach var="esame" 
                                       items="${studente.esamiSupperati}">
                                <li> ${esame.materia.nome} - ${esame.voto}
                            </c:forEach>
                        </ul>
                    </div>    
